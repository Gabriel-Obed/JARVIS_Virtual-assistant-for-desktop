...
def takeCommand():
    ...
    try:
        ...
        print("Hmm... I didn't get please say that again")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # the below condition is for openning other websites that are not mentioned above.
        # this condition asks you for the URL of the website that you want to open.
        # and if there is no such site then it will ask you type the URL of the site.
        # and if still the site is not found then it speaks "Sorry, page not found"
        elif 'open' in text:
            speak("Ok, please say the URL of the website you want to open")
            site_name = takeCommand()
            try:
                webbrowser.open(site_name)
            except:
                try:
                    speak("Sorry, there must have been an error in recognizing yur voice. Please type the URL of the website you want to open")
                    siteName = input("Please type the URL of the website you want to open: ")
                    webbrowser.open(siteName)
                except:
                    speak("Sorry, page not found.")
